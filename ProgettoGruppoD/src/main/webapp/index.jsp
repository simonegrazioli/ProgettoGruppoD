...
<html>
    <head>
        ...
        <link rel="icon" href="/favicon.png" type="img/icona.jpeg" />
    </head>
    <body id="body">
        <div id="container" style="margin-top: 250px; padding: 30px">
            ...
            <div class="row justify-content-center">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link" href="Accedi.jsp" style="color: white"><b>Accedi</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Registrati.jsp" style="color: white"><b>Registrati</b></a>
                    </li>
                </ul>
            </div>
        </div>
